	...
	onReady : function() {
		...
		about = {
				...
				items : [
						{
							xtype : 'panel',
							html : '<center>kyounonihonngo.sinaapp.com是由ChaosYang开发今日的日本语检定的网页和客户端，所用数据均来自<a href="http://www.jiji.com" media="handheld" rel=external>時事ドットコム</a>，并<b>不用作商业用途</b>。欢迎指出bug，提出更好修改建议！</center><center>联系作者:<a href="mailto:yangyang.zhao.thu@gmail.com">yangyang.zhao.thu@gmail.com</a><br></center>',
						} ],
				dockedItems : [ {
					xtype : 'toolbar',
					dock : 'top',
